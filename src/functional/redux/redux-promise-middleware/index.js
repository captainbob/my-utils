...
export default function promiseMiddleware(config = {}) {
    ...
    return ref => {
        ...
        return next => action => {
            ...
            const { resolve, reject, _reducer } = action;
            ...
            const handleReject = reason => {
                ...
                dispatch(Object.assign(rejectedAction, {resolve, reject, _reducer}));
                //throw reason;
            };
            ...
            const handleFulfill = (value = null) => {
                ...
                dispatch(Object.assign({}, resolvedAction, {resolve, reject, _reducer}));
